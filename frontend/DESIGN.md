...
:root {
  ...
  --brand-blue: #2b62e0;
  /* Accent = the logo's cobalt (--brand-blue), lifted for dark surfaces. */
  --accent: light-dark(#2b62e0, #6d95f2);
  /* literal fallbacks; re-derived from --accent in the @supports block */
  --accent-strong: light-dark(#2050c2, #8fb0f6);
  --accent-soft: light-dark(#e2eafc, #1e2c55);
  ...
  --chart-1: light-dark(#2b62e0, #6d95f2);
  --chart-2: #0d9488;
  --chart-3: #d97706;
