...
class Settings(BaseSettings):
    ...
    # CSV override of the OAuth scopes requested on Meta connect. Empty =
    # meta_api.META_SCOPES default. Lets an operator drop a scope the app
    # can't request (Meta's "Invalid Scopes" dialog) without a code change.
    meta_scopes: str = ""
